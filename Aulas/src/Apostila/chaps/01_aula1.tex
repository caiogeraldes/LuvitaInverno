...
\clearpage
{
	\begin{figure}[ht]
		...
		\caption[Silabário regular -- Parte 1]{Silabário regular~\cite[419]{CHLI3}
...
\clearpage
{
	\begin{figure}[ht]
		...
		\caption[Silabário regular -- Parte 2]{Silabário regular~\cite[421]{CHLI3}
	...
	\begin{figure}[ht]
		...
		\caption[Fonogramas CVCV]{Fonogramas CVCV~\cite[422]{CHLI3}}\label{tab:CVCV}
	\end{figure}
}
\clearpage
