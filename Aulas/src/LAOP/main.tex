...
\documentclass[article]{lúvio}

\title{Lúvio hieroglífico: panorama geral da língua e contexto histórico}
...
\begin{compactitem}
	...
	ser lidas \emph{luwili} `em lúvio'.
...
\begin{compactitem}
	\item Os textos em lúvio cuneiforme se encontram junto a textos hititas
	datados dos séculos \textsc{xvi} e \textsc{xv} \textsc{aec}.\footnote{Datação de
		\textcite{Starke1985}.}
	\item Os textos em lúvio hieroglífico se dividem entre:
	\begin{compactitem}
...
\begin{compactitem}
	...
	\begin{compactitem}
		...
		\item conhecida sobretudo pelos textos de culto hitita em lúvio cuneiforme.
...
lúvio estão no sudeste da Anatólia e noroeste da Síria.
...
\chapter{Indo-europeu, anatólico e lúvio}

\section{Antes do lúvio}
...
\begin{compactitem}
	...
	\begin{compactitem}
		...
		\item Junto ao lúvio há o hitita, cário, palaico, lídio e lício.
...
\section{Dialetos do lúvio}

Embora com variações bastante sutis, o lúvio parece ter tido mais de um dialeto
atestado.

\begin{compactitem}
	\item Lúvio hieroglífico e cuneiforme apenas se referem ao \emph{sistema de escrita}.
	\item Há diferenças dentro do lúvio cuneiforme, mesmo em textos de mesma
	época, indicando variação dialetal entre falantes de lúvio da idade do
	bronze. Os textos rituais ligados à região de Kizzuwatna formam um grupo separado
	dos demais.
	\item Há diferenças dentro do lúvio hieroglífico, que formam grupos baseados
...
Entre elas, destaca-se KARATEPE, inscrição bilíngue em fenício e lúvio.
...
\begin{compactitem}
	...
	\item Apenas utilizados na escrita de lúvio, talvez nomes próprios hititas,
	...
	\begin{compactitem}
		...
		\item Silabográfico: o grafema representa uma sílaba, em lúvio apenas séries V,
		CV, CVCV\@.
...
em~\textcite[239--308]{HSK41.1} e, sobre a dialetologia do lúvio,
...
Não há gramáticas ou dicionários de consulta compilados ainda para o lúvio
hieroglífico.
